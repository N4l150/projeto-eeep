  ...
  return (
    <>
      ...
      <section className="bg-white py-12 text-center max-w-5xl mx-auto">
        <h1 className="text-5xl font-bold text-green-900 font-montserrat">Administração</h1>
      </section>
      ...
      <section className="bg-white py-16 px-6 text-center max-w-5xl mx-auto">
        <h2 className="text-4xl font-bold text-green-800 mb-6 font-montserrat">Por que escolher Administração?</h2>
